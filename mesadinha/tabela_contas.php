    ...
    <div class="lista">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table">
                    <div class="alignment"><h2 class="title">Contas</h2></div>
                    <thead>
                    <tr>
                        <th>Codigo</th>
                        <th>Nome</th>
                    ...
                    <?php if ($lista_contas) :
                        foreach ($lista_contas as $conta) :?>
                            <tr>
                                ...
                                <td>
                                    <a href="AlterarContas.php?codigo=<?php echo $conta->codigo;?>" class="btn btn-outline-success "><i class="fa fa-edit"></i> </a>
                                    <a href="tabela_contas.php?codigo=<?php echo $conta->codigo;?>" class="btn btn-outline-danger "><i class="fa fa-trash"></i> </a>
                                </td>
                            </tr>
                ...
                <div class="buttons_alignment">
                    <a href="CadastroContas.php" class="dado btn">Novo</a>
                </div>
            </div>
        </div>
    </div>
