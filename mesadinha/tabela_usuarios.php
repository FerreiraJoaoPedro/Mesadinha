...
<div class="lista">
    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    foreach ($lista_alunos as $aluno) :?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="tabela_usuarios.php?codigo=<?php echo $aluno->codigo;?>" class="btn btn-outline-danger "><i class="fa fa-trash"></i> </a>
                            </td>
                        </tr>
            ...
            <div class="alignment">
                <a href="CadastroUsuarios.php" class="dado btn">Novo</a>
            </div>
        </div>
        </div>
    </div>
